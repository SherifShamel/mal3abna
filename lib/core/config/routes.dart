...
import 'package:mal3abna/features/selecting_teams_feature/pages/selecting_teams_page.dart';
...
class Routes {
  static Route<dynamic> onGeneratedRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case PagesRouteName.selectingTeamsView:
        return MaterialPageRoute(
          builder: (context) => const SelectingTeamsPage(),
          settings: settings,
        );
